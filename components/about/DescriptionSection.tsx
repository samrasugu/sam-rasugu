  ...
  return (
    <div className="py-12 bg-primary-background">
      <div className="flex flex-row gap-7 items-center">
        <User size={34} />
        <h1 className="text-3xl font-bold text-left my-8 text-white">
          About Me
        </h1>
      </div>
      ...
      <p className="text-gray-300 mt-4">
        <p className="text-gray-300 mt-4">
          Drawing on experience with DevOps, I am actively developing skills in this
          area. With a keen interest in cloud computing and CI/CD practices, I
          continuously seek ways to improve development processes, learn new
